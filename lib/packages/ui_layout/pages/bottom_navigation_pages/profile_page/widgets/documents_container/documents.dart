...
import 'bottom_sheet_calendar_documents/bottom_sheet_calendar_documents.dart';
import 'documents_list/documents_list.dart';
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            GetBuilder<ProfileControllerGetxState>(
              builder: (controllerProfile) => SizedBox(
                height: 30,
                child: controllerProfile.searchDocumentsListText != null
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: _rowWithIconsButton(context: context)),
                        ],
                      ),
              ),
            ),
        ...
        GestureDetector(
          onTap: () {
            ProfileControllerGetxState.instance
                .changeIsSearchingDocument(searchText: '');
          },
