...
import 'package:aa_clinic/packages/ui_layout/pages/bottom_navigation_pages/home_page/widgets/notifications/disable_notifications.dart';
      ...
      child: Padding(
        ...
        child: GetBuilder<HomePageCalendarControllerGetxState>(
          builder: (controllerCalendar) {
            ...
            List<DailyCalendarEventsModel?> _dailyTaskSheet = controllerCalendar
                        .eventsForDay[
            ...
            return Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: _dailyTaskSheet.isNotEmpty
                      ? Obx(
                          () => ListView.builder(
                            shrinkWrap: true,
                      ...
                      : Center(
                          child: Text(
                            controllerCalendar.isMarkForDayFun()
                                ? "Загрузка задач на день..."
                                : 'Нет задач на день',
