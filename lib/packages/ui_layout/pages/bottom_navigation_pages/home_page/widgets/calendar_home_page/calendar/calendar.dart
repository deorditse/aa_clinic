        ...
        GetBuilder<HomePageCalendarControllerGetxState>(
          builder: (controllerCalendar) {
            ...
            return TableCalendar(
              ...
              eventLoader: (day) {
                final Map<String, List<int>>? _dateMark = controllerCalendar
                    .marksCountForMonth["${day.year}-${day.month}"];

                return _dateMark?["${day.year}-${day.month}-${day.day}"] ?? [];
              },
              daysOfWeekHeight: 36,
              rowHeight: 50,
              ...
              calendarBuilders: CalendarBuilders(
                ...
                markerBuilder: (BuildContext context, date, events) {
                  ...
                  return Container(
                    ...
                    width: 12,
                    decoration: date.isAfter(DateTime.now())
                        ? const BoxDecoration(
              ...
              lastDay: kLastDay,
              focusedDay: _focusedDay.value,
              //controllerCalendar.mySelectedDay,
              headerVisible: false,
              ...
              onPageChanged: (focusedDay) {
                print(
                    'HomePageCalendarControllerGetxState  _focusedDay _______________ ${_focusedDay.value.toUtc()}');
                HomePageCalendarControllerGetxState.instance
                    .getMonthlyCalendarMarksForMouth(
                        dateMarksMouth: _focusedDay.value);
