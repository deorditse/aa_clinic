      ...
      children: [
        ...
        GetBuilder<HomePageCalendarControllerGetxState>(
          builder: (controllerCalendar) {
            return Obx(
              () {
                Map<String, int>? _marksCountForMonth =
                    controllerCalendar.marksCountForMonth[
                        "${_focusedDay.value.year}-${_focusedDay.value.month}"];
                return TableCalendar(
                  key: Key('HomePageCalendar'),
                  availableGestures: AvailableGestures.horizontalSwipe,
                  eventLoader: _marksCountForMonth != null
                      ? (day) {
                          return _marksCountForMonth[
                  ...
                  holidayPredicate: (day) =>
                      day == controllerCalendar.mySelectedDay,
        ...
        SizedBox(height: myHorizontalPaddingForContainer / 2),
      ],
    );
  }
}
